    ...
    public partial class IntialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BannerId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BannerId1 = table.Column<int>(type: "int", nullable: false),
                    CategoryId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BannerCategories", x => x.BannerId);
                    table.ForeignKey(
                        name: "FK_BannerCategories_Banners_BannerId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BannerProducts", x => x.BannerId);
                    table.ForeignKey(
                        name: "FK_BannerProducts_Banners_BannerId1",
                        column: x => x.BannerId1,
                        principalTable: "Banners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BannerCategories_BannerId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BannerProducts_BannerId1",
